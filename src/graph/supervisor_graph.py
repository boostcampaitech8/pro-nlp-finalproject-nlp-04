...
from agents.supervisor import supervisor_node, ask_user, supervisor_router, prepare_idea_structuring, edit
...
supervisor_graph.add_node("edit_phase", edit)
...
supervisor_graph.add_edge("edit_phase", "supervisor")
